...
import com.example.eventadmin.databinding.ActivitySignUpBinding
import com.example.eventadmin.model.UserModel
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.createUserButton.setOnClickListener {
            ...
            nameOfShop = binding.shopName.text.toString().trim()
