...
import com.example.eventadmin.adapter.PendingOrderAdapter
import com.example.eventadmin.databinding.ActivityPendingOrderBinding
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    private var listOfImageFirstitemOrder: MutableList<String> = mutableListOf()
    ...
    private fun getOrdersDetails() {
        ...
        databaseOrderDetails.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@PendingOrderActivity, "Failed to fetch data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun addDataToListForRecyclerView() {
        for (orderItem in listOfOrderItem) {
            ...
            orderItem.itemImages?.filterNot { it.isEmpty() }?.forEach {
                listOfImageFirstitemOrder.add(it)
            }
        }
        setAdapter()
    }
    ...
    private fun setAdapter() {
        ...
        val adapter = PendingOrderAdapter(this, listOfName, listOfTotalPrice, listOfImageFirstitemOrder, this)
    ...
    override fun onItemDispatchClickListener(position: Int) {
        ...
        dispatchItemOrderReference.setValue(listOfOrderItem[position])
            ...
            .addOnFailureListener {
                Toast.makeText(this@PendingOrderActivity, "Order is not Dispatched", Toast.LENGTH_SHORT).show()
            }
    }
    ...
    private fun deleteThisItemFromOrderDetails(dispatchItemPushKey: String) {
        ...
        orderDetailsItemsReference.removeValue()
            .addOnSuccessListener {
                Toast.makeText(this@PendingOrderActivity, "Order is Dispatched", Toast.LENGTH_SHORT).show()
            }
            .addOnFailureListener {
                Toast.makeText(this@PendingOrderActivity, "Order is not Dispatched", Toast.LENGTH_SHORT).show()
            }
